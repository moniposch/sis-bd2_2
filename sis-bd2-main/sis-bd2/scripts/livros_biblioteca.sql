...
CREATE TABLE `biblioteca` (
  ...
  KEY `fk_bibliotecaleitor` (`leitor_id`),
  KEY `fk_livro` (`livro_id`),
  CONSTRAINT `fk_bibliotecaleitor` FOREIGN KEY (`leitor_id`) REFERENCES `leitor` (`leitor_id`),
...
INSERT INTO `biblioteca` VALUES (1,2,1),(2,3,1),(3,5,1),(4,1,2);
